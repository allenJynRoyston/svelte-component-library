    ...
    <Section>
      <section class='section-wrap'>
        ...
        <p>
          ...
          <ColorText type='warning'><Link target="_blank" href='https://svelte.dev/' inherit>Svelte</Link></ColorText> framework and 
          <ColorText type='magic'><Link target="_blank" href='https://www.snowpack.dev/' inherit>Snowpack</Link></ColorText> build tool.            
        ...
        <p>
          When your ready, projects are bundled via <ColorText type='secondary'><Link target="_blank" href='https://www.snowpack.dev/' inherit>Rollup</Link></ColorText> for the smallest possible size (although Webpack and Parcel configurations are available too).
        </p>
      </section> 
    </Section>
  </Container>
    ...
    <Section>
      <section class='section-wrap'>
        ...
        <p>
          ...
          If you know a little bit of <ColorText type='warning'><Link target="_blank" href='https://svelte.dev/' inherit>Svelte</Link></ColorText>, functionality can be extended with ease.
        </p>
        <p>
...
<ThemeWrapper alwaysdark={theme === 'dark'} alwayslight={theme === 'light'}>
  ...
  $npm run build
          ...
          And because this is <ColorText type='warning' ><Link target="_blank" href='https://svelte.dev/' inherit>Svelte</Link></ColorText>, the entire app will be compiled into pure untainted Javascript, 
        ...
        <p>
          And on a personal note, while I love and adore React and Vue for their own merits, developing with <ColorText type='warning' ><Link target="_blank" href='https://svelte.dev/' inherit>Svelte</Link></ColorText> is just a much better experience.
        </p>
      </section> 
    </Section>
  </Container>
